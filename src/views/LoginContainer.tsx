...
// ** Demo Imports
import FooterIllustrationsV1 from 'src/@core/views/pages/auth/FooterIllustration'
          ...
          <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
            ...
            <Box sx={{ mb: 6 }}>
              <Typography variant='h5' sx={{ fontWeight: 600, marginBottom: 1.5 }}>
                Hoş Geldiniz {themeConfig.templateName}! 👋🏻
              </Typography>
              <Typography variant='body2'>Lütfen hesabınızda oturum açın ve maceraya başlayın</Typography>
            </Box>
            <form noValidate autoComplete='off' onSubmit={formik.handleSubmit}>
              ...
              >
                ...
                <Link passHref href='/forgot-password'>
                  <LinkStyled>Şifrenizi mi unuttunuz?</LinkStyled>
                </Link>
              </Box>
